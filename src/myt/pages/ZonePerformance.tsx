          ...
          return (
            <div key={z.zoneId} className="glass-card p-4">
              ...
              <p className="text-[10px] text-muted-foreground mb-3">
                {flowCount} Flow Ops · {tcmCount} TCM
              </p>
              <div className="space-y-1.5 text-xs">
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Tours</span>
                  <span className="text-foreground font-medium">{z.toursScheduled}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Completed</span>
                  <span className="text-foreground font-medium">{z.toursCompleted}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-role-hr font-medium">{z.drafts}</span>
                </div>
              </div>
            </div>
          );
