    ...
    <div className="space-y-4 md:space-y-6 animate-slide-up">
      <div>
        ...
        <p className="text-xs md:text-sm text-muted-foreground">
          {draftTours.length} drafts need rent agreement follow-up
        </p>
      </div>
      ...
      <div className="md:hidden space-y-2">
        ...
        {draftTours.length === 0 && (
          <p className="text-center text-muted-foreground py-8">No drafts to track</p>
        )}
      </div>
                ...
                <tr key={t.id} className="border-b border-border/50 hover:bg-accent/30">
                  ...
                  <td className="py-2.5 px-2">
                    <div className="flex gap-1">
                      ...
                      <button className="p-1.5 rounded-md bg-hr/10 text-role-hr hover:bg-hr/20">
