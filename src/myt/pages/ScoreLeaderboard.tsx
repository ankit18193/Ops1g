        ...
        {rows.slice(0, 12).map((r) => (
          <div key={r.id} className="flex items-center gap-3">
            ...
            <div className="text-xs tabular-nums w-20 text-right">
              {r.avg} <span className="text-muted-foreground">({r.count})</span>
            </div>
          </div>
        ))}
      </div>
    ...
    <div className="space-y-4 max-w-6xl mx-auto">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          ...
          <Link className="underline" to="/myt/settings">
            Settings
          </Link>
      ...
      <div className="grid md:grid-cols-3 gap-3">
        <Card>
          <CardHeader>
            <CardTitle className="text-base">TCM ranking</CardTitle>
          </CardHeader>
          <CardContent>
            <Bars rows={tcmRanks} />
          </CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Property ranking</CardTitle>
          </CardHeader>
          <CardContent>
            <Bars rows={propRanks} />
          </CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Area ranking</CardTitle>
          </CardHeader>
          <CardContent>
            <Bars rows={areaRanks} />
          </CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Top scoring tours</CardTitle>
        </CardHeader>
        <CardContent>
              ...
              .map(({ tour, score }) => (
                ...
                >
                  <div className="text-sm">
                    ...
                    <span className="text-muted-foreground">{tour.assignedToName}</span>
                  </div>
