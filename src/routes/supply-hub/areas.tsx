      ...
      <div className="space-y-5">
        ...
        <header>
          ...
          <h1 className="font-display text-2xl font-semibold tracking-tight">
            Where each Bangalore zone fits
          </h1>
          <p className="text-sm text-muted-foreground mt-1">
            Crowd, age band, nightlife, weekend feel — instant context for any lead's location
            question.
          </p>
        </header>
              ...
              <div key={a.area} className={cn("rounded-lg border bg-card p-4", tone)}>
                <div className="flex items-center justify-between">
                  <h3 className="font-display text-lg font-semibold flex items-center gap-1.5">
                    <MapPin className="h-4 w-4 text-accent" /> {a.area}
                  </h3>
