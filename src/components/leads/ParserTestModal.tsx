        ...
        {!report && (
          <div className="space-y-3 py-2">
            <p className="text-sm text-muted-foreground">
              Run the parser against a CSV of raw pastes (must include a <code>rawText</code>{" "}
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1.5">
                {Object.entries(report.missing).map(([k, v]) => (
                  <Badge
                    key={k}
                    variant={v === 0 ? "secondary" : "destructive"}
            ...
            <div className="rounded-lg border border-border max-h-56 overflow-auto">
              ...
              {report.rows.length > 50 && (
                <div className="text-[10px] text-muted-foreground text-center py-1.5">
                  + {report.rows.length - 50} more rows
                </div>
              )}
            </div>
          </div>
